...
use Hkm_Request\Requests\Requests_IRI;
use Hkm_Request\Requests\Requests_Hooks;
use Hkm_Request\Requests\Requests_Response;
use Hkm_Request\Requests\Requests_Exception;
use Hkm_Request\Requests\Requests_IDNAEncoder;
use Hkm_Request\Requests\Auth\Requests_Auth_Basic;
use Hkm_Request\Requests\Proxy\Requests_Proxy_HTTP;
use Hkm_Request\Requests\Cookie\Requests_Cookie_Jar;
use Hkm_Request\Requests\Response\Requests_Response_Headers;

/**
 * Requests for PHP
 *
 * Inspired by Requests for Wordpress.
 *
 * Based on concepts from SimplePie_File, RequestCore and Hkm_Request_Http.
 *
 * @package Requests
 */
...
class Requests {
	...
	public static function add_transport($transport) {
		if (empty(self::$transports)) {
			self::$transports = array(
				'Hkm_Request\Requests\Transport\Requests_Transport_cURL',
				'Hkm_Request\Requests\Transport\Requests_Transport_fsockopen',
			);
		}
	...
	protected static function get_default_options($multirequest = false) {
		$defaults = array(
			'timeout'          => 10,
			'connect_timeout'  => 10,
			'useragent'        => 'Hkm_Requests/' . self::VERSION,
	...
	public static function get_certificate_path() {
		...
		return dirname(__FILE__) . '/certificates/ca-bundle.crt';
	}
