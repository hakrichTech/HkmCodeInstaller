...
class UserUsernameModel extends Model
{
	...
	protected static $allowedFields        = ['user_id','username','deleted_at','verified','updated_at','email', 'password', 'created_at','userFullname','phone','birthDate'];
