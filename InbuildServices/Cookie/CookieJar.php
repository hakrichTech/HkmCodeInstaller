...
class CookieJar {
	 ...
	 * @param  bool    $secure
	 * @param  bool    $httpOnly
	 * @return Hkm_code\Cookie\Cookie
	 */
	public function make($name, $value, $minutes = 0, $path = null, $domain = null, $secure = false, $httpOnly = true):Cookie
	{
		...
		$cookie = new Cookie($name, $value??'', $newDefaults);
	 ...
	 * @return Hkm_code\Cookie\Cookie
	 */
	public function queued($key, $default = null) :Cookie
	{
