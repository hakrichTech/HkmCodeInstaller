<div class="col-xl-8 col-lg-7 col-md-8 col-sm-12 tw_mb-[30px]">
					   <div class="tw_bg-slate-100 tw_rounded-[10px] dark:tw_bg-slate-800 tw_text-slate-800 dark:tw_text-slate-300  !tw_h-[100%] !tw_overflow-hidden">
							<div class="profile-tab tw_h-[100%]">
								<div class="tab tw_h-[100%]">
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade show active" id="timeline" role="tabpanel">
											<div class="pd-20">
												<div class="profile-timeline">
													<div class="timeline-month tw_text-slate-800 dark:tw_text-slate-300">
														<h5 class="tw_text-slate-800 dark:tw_text-slate-300">August, 2020</h5>
													</div>
													...
													<div class="timeline-month tw_text-slate-800 dark:tw_text-slate-300">
														<h5 class="tw_text-slate-800 dark:tw_text-slate-300">July, 2020</h5>
													</div>
													<div class="profile-timeline-list">
														<ul>
															<li>
													...
													<div class="timeline-month tw_text-slate-800 dark:tw_text-slate-300">
														<h5 class="tw_text-slate-800 dark:tw_text-slate-300">June, 2020</h5>
													</div>
													<div class="profile-timeline-list">
														<ul>
															<li>
										...
										<div class="tab-pane fade" id="tasks" role="tabpanel">
											<div class="lg:tw_p-[20px] tw_p-[5px] profile-task-wrap">
												<div class="tw_w-[100%] tw_py-6 lg:tw_px-10 tw_px-4">
													<!-- Open Task start -->
													<div class="task-title row align-items-center">
														<div class="col-md-8 col-sm-12">
															<h5 class="tw_text-slate-800 dark:tw_text-slate-300">Open Tasks (4 Left)</h5>
														</div>
													...
													<div class="profile-task-list pb-30">
														<ul>
															<li class="tw_text-slate-800 dark:tw_text-slate-300">
										...
										<!-- Setting Tab start -->
										<?php
                                         include_once __DIR__."/tab.edit.profile.php";
										?>
										<!-- Setting Tab End -->
									</div>
								</div>
