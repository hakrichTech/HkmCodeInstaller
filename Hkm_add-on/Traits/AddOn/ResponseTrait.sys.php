...
trait ResponseTrait
{
	...
	public static function GET_JSON()
	{
		...
		{
			$body = Services::FORMAT()::GET_FORMATTER('application/json')::FORMAT($body);
		}
	...
	public static function GET_XML()
	{
		...
		{
			$body = Services::FORMAT()::GET_FORMATTER('application/xml')::FORMAT($body);
		}
	...
	protected static function FORMAT_BODY($body, string $format)
	{
		...
		{
			$body = Services::FORMAT()::GET_FORMATTER($mime)::FORMAT($body);
		}
	 ...
	 */
	public static function DOWNLOAD(string $filename = '', $data = '', bool $setMime = false)
	{
		if ($filename === '' || $data === '')
		{
			return null;
