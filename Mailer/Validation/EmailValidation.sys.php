<?php
namespace TeamsMailerSystem\Validation;

use \Hkm_addIn\AddInObject\implementess\mail_verif as constant;

class EmailValidation implements constant\mail_verif
{
  private static $mail;
