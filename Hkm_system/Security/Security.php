...
class Security implements SecurityInterface
{
	 ...
	 *
	 * @deprecated Use `Hkm_code\Security\Security::verify()` instead of using this method.
	 *
	 * @codeCoverageIgnore
	 */
	public function CSRFVerify(Request $request)
	{
	 ...
	 * @return string|null
	 *
	 * @deprecated Use `Hkm_code\Security\Security::getHash()` instead of using this method.
	 *
	 * @codeCoverageIgnore
	 */
	 ...
	 * @return string
	 *
	 * @deprecated Use `Hkm_code\Security\Security::getTokenName()` instead of using this method.
	 *
	 * @codeCoverageIgnore
	 */
	...
	public function verify(Request $request)
	{
		...
		if ($request::HAS_HEADER($this->headerName) && ! empty($request::GET_HEADER($this->headerName)->getValue()))
		{
			$tokenName = $request::GET_HEADER($this->headerName)->getValue();
		}
		else
		{
			$json = json_decode($request::GET_BODY());

			if (! empty($request::GET_BODY()) && ! empty($json) && json_last_error() === JSON_ERROR_NONE)
			{
	...
	public function sanitizeFilename(string $str, bool $relativePath = false): string
	{
		...
		$str = hkm_remove_invisible_characters($str, false);
	 ...
	 */
	protected function sendCookie(Request $request)
	{
		if ($this->cookie->isSecure() && ! $request::IS_SECURE())
		{
			return false;
		}
