...
class Validation implements ValidationInterface
{
	...
	public static function GET_ERRORS(): array
	{
		...
		if (empty(self::$errors) && ! hkm_is_cli() && isset($_SESSION, $_SESSION['_hkm_validation_errors']))
		{
			self::$errors = unserialize($_SESSION['_hkm_validation_errors']);
		}
	 ...
	 * @return string
	 */
	protected static function GET_ERROR_MESSAGE(string $rule, string $field, string $label = null, string $param = null, string $value = null): string
	{
