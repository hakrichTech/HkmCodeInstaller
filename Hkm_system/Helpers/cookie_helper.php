...
//=============================================================================
// Hkm_code Cookie Helpers
//=============================================================================

if (! function_exists('hkm_set_cookie'))
{
	/**
	 * Set cookie
	 *
	 ...
	 *
	 * @see \Hkm_code\HTTP\Response::setCookie()
	 */
	function hkm_set_cookie(
		$name,
		string $value = '',
		string $expire = '',
		string $domain = '',
...
if (! function_exists('hkm_get_cookie'))
{
	/**
	 ...
	 * @return mixed
	 *
	 * @see \Hkm_code\HTTP\IncomingRequest::getCookie()
	 */
	function hkm_get_cookie($index, bool $xssClean = false)
	{
		$prefix  = isset($_COOKIE[$index]) ? '' : hkm_config(App::class)->cookiePrefix;
...
if (! function_exists('hkm_delete_cookie'))
{
	/**
	 * Delete a cookie
	 *
	 ...
	 * @return void
	 *
	 * @see \Hkm_code\HTTP\Response::deleteCookie()
	 */
	function hkm_delete_cookie($name, string $domain = '', string $path = '/', string $prefix = '')
	{
		Services::response()->deleteCookie($name, $domain, $path, $prefix);
	}
}

if (! function_exists('hkm_has_cookie'))
{
	/**
	 ...
	 * @return boolean
	 */
	function hkm_has_cookie(string $name, string $value = null, string $prefix = ''): bool
	{
