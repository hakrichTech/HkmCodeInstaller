...
class URI
{
	...
	public  function __toString(): string
	{
		...
		return static::CREATE_URI_STRING(
			$scheme, self::GET_AUTHORITY(), $path, // Absolute URIs should use a "/" for an empty path
	...
	public static function RESOLVE_RELATIVE_URI(string $uri)
	{
		...
		if (! empty($relative::GET_AUTHORITY()))
		{
			$transformed::SET_AUTHORITY($relative::GET_AUTHORITY())
		...
		else
		{
			...
			$transformed::SET_AUTHORITY(self::GET_AUTHORITY());
		}
	...
	{
		if (! empty($base::GET_AUTHORITY()) && $base::GET_PATH() === '')
		{
