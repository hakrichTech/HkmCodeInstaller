...
return [
	...
	'generator'           => [
		...
		'className'        => [
			...
			'AppDatabaseUser'     => 'Database Username',
			'AppDatabasePass'     => 'Database Password',
			'AppUser'     => 'Admin Email',
			'AppUserPass'     => 'Admin Password',
		...
		'usingCINamespace' => 'Warning: Using the "{0}" namespace will generate the file in the system directory.'
	],
