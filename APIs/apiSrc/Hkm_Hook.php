...
class Hkm_Hook  implements Iterator, ArrayAccess
{
    ...
    /**
	 * Normalizes filters set up before WordPress has initialized to Hkm_Hook objects.
	 *
	 ...
	 *
	 *     $filters = array(
	 *         'hkm_fatal_error_handler_enabled' => array(
	 *             10 => array(
	 *                 array(
	 *                     'accepted_args' => 0,
	 *                     'function'      => function() {
	 ...
	 * @return Hkm_Hook[] Array of normalized filters.
	 */
