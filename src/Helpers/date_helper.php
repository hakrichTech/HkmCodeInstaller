...
if (! function_exists('hkm_timezone_select'))
{
	/**
	 ...
	 * @throws Exception
	 */
	function hkm_timezone_select(string $class = '', string $default = '', int $what = DateTimeZone::ALL, string $country = null): string
	{
