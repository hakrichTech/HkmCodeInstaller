...
namespace Hkm_code\Log;

use Hkm_code\Exceptions\Log\LogException;
use Hkm_code\Log\Handlers\HandlerInterface;
...
class Logger implements LoggerInterface
{
	 ...
	 */
	public function __construct(\Hkm_code\Vezirion\BaseVezirion $config, bool $debug = HKM_DEBUG)
	{
		...
		{
			throw LogException::FOR_NO_HANDLERS('LoggerConfig');
		}
	...
	public function log($level, $message, array $context = []): bool
	{
		...
		{
			throw LogException::FOR_INVALID_LOG_LEVEL($level);
		}
	...
	protected function interpolate($message, array $context = [])
	{
		...
		if (!hkm_is_cli())
		{
			...
			$replace['{session_vars}'] = '$_SESSION: ' . print_r($SESSION->all(), true);
		}
